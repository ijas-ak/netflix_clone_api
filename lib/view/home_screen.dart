                  ...
                  Stack(
                    ...
                    children: [
                      Container(
                        ...
                        child: Image.network(
                          "https://static1.srcdn.com/wordpress/wp-content/uploads/2024/01/john-wick-franchise-poster.jpg",
                          fit: BoxFit.fill,
                        ),
                      ),
                      Padding(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) {
                                      return MovieDetails(
                                        ...
                                        image: movieImage,
                                        rating:
                                            provider.trending[index].rating
                                                .toString(),
                                        releasedate:
                                            provider
                                                .trending[index]
                                ...
                                () => Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) {
                                      return MovieDetails(
                                        description:
                                            provider.popular[index].description,
                                        title: provider.popular[index].title,
                                        image: popularMovieImage,
                                        rating:
                                            provider.popular[index].rating
                                                .toString(),
                                        releasedate:
                                            provider.popular[index].releasedate,
                                      );
                                    },
                                  ),
                                ),
